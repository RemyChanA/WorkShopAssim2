#include "headers.h"
/***************************main****************************/
void choose_service(int s)
{
    if (s==exception_number)
        user ();
    else if(s==calculator_or_cinema_tickets)
        user_pick();
    else if(s==powers)
        power();
    else if (s==seq_stars)
        seq_star();
    else if (s==christmas_trees)
        christmas_tree();
    else if (s==swap_vari)
        swap_var();
    else if (s==swap_arrays)
         swap_var_arr ();
    else if(s==flip_array)
        swap_var_arr ();
    else if(s==array_entry)
        Array_Entry();
    else if (s==battery_statement)
        battery_low();

    else if (s==Fibonacci_series_program)
        input_Fibonacci ();
    else
        printf("\n Error \n");
}
